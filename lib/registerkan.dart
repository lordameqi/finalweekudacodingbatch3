...
class Registerkan extends StatefulWidget {
  @override
  _RegisterkanState createState() => _RegisterkanState();
}

class _RegisterkanState extends State<Registerkan> {
  ...
  Future userRegistration() async {
    ...
    // SERVER API URL
    var url = 'http://192.168.1.6/finalweek/daftarin.php';
